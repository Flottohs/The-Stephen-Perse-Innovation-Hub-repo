        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 border-2 border-purple-200 shadow-xl">
              ...
              <div className="relative bg-gradient-to-br from-emerald-100/50 via-teal-50/50 to-cyan-100/50 rounded-xl p-12 h-[1200px] border-4 border-teal-200 shadow-inner overflow-hidden">
